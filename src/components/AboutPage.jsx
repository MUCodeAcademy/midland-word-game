      ...
      <Grid container item xs={12} sm={6}>
        ...
        <Grid item xs={9}>
          <Box className="padding-10">
            ...
            <Typography variant="body2">
              Hi there! *waves* I'm Tom. I'm an aspiring Software Developer just
              recently finishing up a Code Bootcamp at Midland Code Academy.
              When I'm not sobbing in my car by myself about how terrible I am
              at coding, I like to engage in self-deprecating humor to get
              people to like me. Byeeeeeee.
            </Typography>
            <IconButton
